...
def object():
	p.setAdditionalSearchPath(pybullet_data.getDataPath())
	object_id = p.loadURDF(OBJECT_PATH+'object1/object1.urdf',
							basePosition=[0.48, 0.1, -0.001],
							baseOrientation=[0, 0, 0, 1.0],
							globalScaling=1.0)
	return object_id
...
def obstacle():
	p.setAdditionalSearchPath(pybullet_data.getDataPath())
	obstacle_id = p.loadURDF(OBJECT_PATH+'object1/object1.urdf',
							basePosition=[0.48, 0.1, -0.001],
							baseOrientation=[0, 0, 0, 1.0],
							globalScaling=1.0)
	return obstacle_id
...
def block():
	p.setAdditionalSearchPath(pybullet_data.getDataPath())
	block_id = p.loadURDF(OBJECT_PATH+'object1/object1.urdf',
