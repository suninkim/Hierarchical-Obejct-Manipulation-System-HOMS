...
def run():
	...
	parser.add_argument('--env_type', type=str, default='OfflineRL')
	...
	configs = {
		...
		'latent_lr': 1e-4,
		'latent_dim': 256,
		'hidden_units': [512, 512, 512, 512, 512],#[512, 1024, 1024],
		...
		'dataset_type':'expert', # 'expert', '50%'
		'use_cql':True,
		'use_bc':True,
  		'task_ratio':False,
	    'reward_ratio':None,
		'policy_type': 'Stochastic' # 'Stochastic'-SAC, 'Deterministic'-TD3
	}

	env = PandaEnv(gui=args.gui)
 
	log_dir = os.path.join('logs', args.env_type)
