...
def make_action_drawer_open(robotId, targetPoint, targetOrientation, targetVector, is_gripper_open, cur_point=0):
    ...
    open_ran = random.uniform(0.165, 0.175)
    pos_1 = np.concatenate((targetPoint, (targetOrientation,)))
    pos_2 = pos_1.copy()
    pos_1[2] += 0.05
    pos_3 = pos_2.copy()
    pos_3[:3] = pos_3[:3] - open_ran*targetVector
    pos_4 = pos_3.copy()
    pos_4[2] += 0.10
...
def make_action_drawer_close(robotId, targetPoint, targetOrientation, targetVector, is_gripper_open, cur_point=0):
    ...
    close_ran = random.uniform(0.17, 0.18)
    pos_1 = np.concatenate((targetPoint, (targetOrientation,)))	
    pos_1[:3] = pos_1[:3]
    pos_3 = pos_1.copy()
    pos_2 = pos_1.copy()
    pos_1[2] += 0.05
    pos_3[:3] = pos_3[:3] + close_ran*targetVector
    pos_4 = pos_3.copy()
    pos_4[2] += 0.10
...
def make_action_box_push(robotId, targetPoint, targetOrientation, targetVector, is_gripper_open, cur_point=0):
    ...
    ori_diff = abs(targetOrientation- eeOri[2])
    push_ran = random.uniform(0.28, 0.30)
    pos_1 = np.concatenate((targetPoint, (targetOrientation,)))
    pos_2 = pos_1.copy()
    pos_1[2] += 0.05
    pos_3 = pos_2.copy()
    pos_3[:3] = pos_3[:3] + push_ran*targetVector
    pos_4 = pos_3.copy()
    pos_4[2] += 0.07
